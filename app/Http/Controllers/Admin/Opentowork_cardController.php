...
class Opentowork_cardController extends Controller
{
    ...
    {
		return view('admin/opentowork_cards.index',[
    ...
    {
        $opc = Opentowork_card::find($id);
        $opc->delete();
		
        $message = 'Card Deleted Successfully';
        return redirect()->action('Admin\Opentowork_cardController@index')->with('message',$message);
    }
