		...
		<div class="col-md-10 mx-auto mt-4 ">
			...
			<div class="row m-0 p-0 msg_body">
              ...
              <div class="post-container">                
                ...
                @else 
                  <img class="" src="{{ $user->profile_image() }}" style="width:50px;">
                @endif
                </div>
                <div class="post-content">
                    <h3 class="post-title p-0 m-0 ellipsis" onclick="toggleEllipsis(this)">{{ $user->full_name }}</h3>
                    <p class="msg_profession ellipsis" onclick="toggleEllipsis(this)">{{ $user->profession }}</p>
                </div>
