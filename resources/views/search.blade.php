		...
		<div class="col-md-10 mx-auto mt-5">
			...
			<div class="row m-0 p-0" id="search">
				<div class="col-md-7 form-group form-inline has-search m-0 p-0 search_filter_item_block_new">
					...
					<input type="text" name="search" class="form-control w-100 search_input" placeholder="Search for opportunitities, open-to-work cards or users" value="{{ isset($_GET['search']) ? $_GET['search'] : '' }}">
				</div>
							...
							<div class="card-header pl-4 pr-4 color-user h-100" style="height:54px !important">
								<div class="row m-0 p-0 opportunity_header hide_tablet">
									@if($u->looking_for == 1)
										...
										<p class="pl-4 text-right font-weight-bold"><span class="fa fa-map-marker"></span><span class="pl-2">{{ isset($countries[$u->country_code]) ? $countries[$u->country_code] : $u->country_code }}, {{ $u->city }}</span></p>
									...
									<p class="w-65 m-0 p-0 text-right font-weight-bold"><span class="fa fa-map-marker"></span><span class="pl-2">{{ isset($countries[$u->country_code]) ? $countries[$u->country_code] : $u->country_code }}, {{ $u->city }}</span></p>
									@endif
								</div>
								<!-- mobile -->
								<div class="row m-0 p-0 opportunity_header show_tablet">
									@if($u->looking_for == 1)
										...
										<p class="w-50 m-0 p-0 text-right font-weight-bold ellipsis" onclick="toggleEllipsis(this)"><span class="fa fa-map-marker"></span><span class="pl-2">{{ isset($countries[$u->country_code]) ? $countries[$u->country_code] : $u->country_code }}, {{ $u->city }}</span>
										</p>
									...
									<p class="w-65 m-0 p-0 text-right font-weight-bold pull-left ellipsis" onclick="toggleEllipsis(this)"><span class="fa fa-map-marker"></span><span class="pl-2">{{ isset($countries[$u->country_code]) ? $countries[$u->country_code] : $u->country_code }}, {{ $u->city }}</span></p>
									@endif
								</div>
							</div>
							<div class="card-block p-4">
