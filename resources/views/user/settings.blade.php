                ...
                <div class="row m-0 p-0 mt-2">					
					<div class="w-100 mt-3 profile_pitch">
                        ...
                        <div class="form-group form-inline p-0 m-0 mt-2">
							...
							<input class="form-control col-md-9 opc_title" type="text" autocomplete="off" name="email"   value="{{ old('email') !== null ? old('email') : $user->email }}">
						...
						<div class="form-group form-inline p-0 m-0 mt-2">
                            <div class="col-md-3 p-0 m-0">
								<button type="button" id="activeNotification" data-title="{{ $user->unsubscribe == 1 ? 'Activate Email Notification'  : 'Deactivate Email Notification' }}" class="settingsButton btn-noti_email-color">{{ $user->unsubscribe == 1 ? 'Activate Email Notification'  : 'Deactivate Email Notification' }}</button>
							</div>
                            <div class="col-md-9 p-0 m-0">
							</div>
                        ...
                        <div class="form-group form-inline p-0 m-0 mt-2">
                            <div class="col-md-3 p-0 m-0 mb-3">
								...
								<button type="button" id="hideAccount" data-title="{{ $user->is_hidden == 1 ? 'Unhide'  : 'Hide' }}" class="settingsButton btn-hide-color">{{ $user->is_hidden == 1 ? 'Unhide account'  : 'Hide account' }}</button>
							</div>
                            <div class="col-md-9 p-0 m-0">
