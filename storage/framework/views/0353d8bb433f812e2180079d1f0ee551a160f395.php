...
<div class="row m-0">
    <div class="col-md-10 mx-auto mt-5">
        <div class="mt-5 mb-5">
            ...
            <h4 class="mt-5">
            3) Press “Send open-to-work” then either select one of your open-to-work cards or create a new one to send
            </h4>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\XAMPP7.4\htdocs\growyspace 2.0\resources\views/info/oportunity_guide.blade.php ENDPATH**/ ?>