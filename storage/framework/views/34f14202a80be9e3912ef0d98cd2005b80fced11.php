                    ...
                    <div class="row justify-content-center">
                        <div class="col">
                            <div class="card">
                                ...
                                <?php echo Form::open(['url' => '/user/registration', 'method' => 'POST']); ?>
                                ...
                                <div class="card-block p-4">
                                    <div class="row m-0 p-0 ">	
                                        ...
                                        <div class="w-100 mt-3 profile_pitch">
                                            ...
                                            <div class="form-group form-inline p-0 m-0 mt-2 <?php echo e(((count($errors->get('full_name')) > 0) ? 'has-error' : '')); ?>">
                                                <label class="col-md-3 justify-content-start p-0" for="role">Full Name:</label>
                                                <input class="form-control col-md-9 " type="text" autocomplete="no" name="full_name" placeholder="Full Name" value="<?php echo e(old('full_name') !== null ? old('full_name') : ''); ?>">
                                                <?php if(count($errors->get('full_name')) > 0): ?>
                                                    <p class="inline_error"><?php echo e($errors->first('full_name')); ?></p>
                                                <?php endif; ?>
                                            </div>
                                            <div class="form-group form-inline p-0 m-0 mt-2 <?php echo e(((count($errors->get('email')) > 0) ? 'has-error' : '')); ?>">
                                                ...
                                                <input class="form-control col-md-9 " type="text" autocomplete="no" name="email" class="form-control" placeholder="Email" value="<?php echo e(old('email') !== null ? old('email') : ''); ?>">
                                                <?php if(count($errors->get('email')) > 0): ?>
                                                    <p class="inline_error"><?php echo e($errors->first('email')); ?></p>
                                                <?php endif; ?>
                                            </div>
                                            <div class="form-group form-inline p-0 m-0 mt-2 <?php echo e(((count($errors->get('profession')) > 0) ? 'has-error' : '')); ?>">
                                                <label class="col-md-3 justify-content-start p-0" for="role">Profession:</label>
                                                <input class="form-control col-md-9 " type="text" autocomplete="no" name="profession" class="form-control" placeholder="Profession" value="<?php echo e(old('profession') !== null ? old('profession') : ''); ?>">
                                                <?php if(count($errors->get('profession')) > 0): ?>
                                                    <p class="inline_error"><?php echo e($errors->first('profession')); ?></p>
                                                <?php endif; ?>
                                            </div>
                                            
                                            <div class="mt-3 mb-3 w-100">
                                                <h3 class="font-weight-bold">Looking for</h3>
                                                <?php if(count($errors->get('looking_for')) > 0): ?>
                                                    <p class="inline_error" style="text-align: left;"><?php echo e($errors->first('looking_for')); ?></p>
                                                <?php endif; ?>
                                            </div>		
                                            ...
                                            <div class="form-group form-inline p-0 m-0 mt-2 <?php echo e(((count($errors->get('country_code')) > 0) ? 'has-error' : '')); ?>">
                                                ...
                                                <select class="form-control opc_country_code col-md-5 mb-2 exp_country"  name="country_code">
                                                    <option value="">Select a Country</option>
                                                        <?php $__currentLoopData = config('yourconfig.countries'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country_code => $coutry_name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option 
                                                                <?php if(old('country_code') !==null && old('country_code') == $country_code): ?>
                                                                    selected
                                                                <?php endif; ?>
                                                            value="<?php echo e($country_code); ?>"><?php echo e($coutry_name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>	
                                                </select>
                                                <div class="col-md-4 m-0 p-0 mb-2 has-location <?php echo e(((count($errors->get('city')) > 0) ? 'has-error' : '')); ?>">
                                                    <span class="fa fa-map-marker form-control-marker"></span>
                                                    <input type="text" placeholder="city" class="opc_city form-control w-100 " name="city" placeholder="City" value="<?php echo e(old('city') !== null ? old('city') : ''); ?>" />
                                                </div>
                                            ...
                                            <div class="form-group form-inline p-0 m-0 mt-2">
                                                ...
                                                <?php if(count($errors->get('password_confirmation')) > 0): ?>
                                                    p class="inline_error"><?php echo e($errors->first('password_confirmation')); ?></p>
                                                <?php endif; ?>
                                            </div>           
...
</div><?php /**PATH F:\XAMPP7.4\htdocs\growyspace 2.0\resources\views/popups/signup.blade.php ENDPATH**/ ?>