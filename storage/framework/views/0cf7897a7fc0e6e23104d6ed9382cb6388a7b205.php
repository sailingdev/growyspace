...
<div class="row m-0 bg-gray">
    ...
    <div class="col-md-8 mx-auto" >
        ...
        <div class="card mt-5 mb-2 bgcolor-e1e3dd">
            ...
            <?php endif; ?>
            <?php if($opc && $opc->refer == 1 && !$third_person): ?> 
            <div class="card-header pl-4 pr-4 color-opentowork h-100 hidden_opc">
                <div class="d-flex m-0 p-0 opportunity_header">
                    ...
                    <div class="hiddenState_opt_edit">
                        ...
                        <?php if(!$third_person): ?>
                            <a href="<?php echo e(URL::to('/')); ?>/opentowork/<?php echo e($opc->id); ?>/edit" class="text-decoration-none text-white"> <img src="/assets/images/Icon-edit.svg" style="width:30px;"><span class="pl-2">Edit</span></a>
                        <?php endif; ?>
                        </p>
                    </div>
            ...
            <div class="card-block p-4">
                ...
                <div class="row m-0 p-0 ">
                    <div class="mt-3 w-100 profile_experience">
                        ...
                        <div class="row m-0 p-0 mb-2 profile_company hide_mobile">
                            <p class="w-50 m-0 p-0 font-weight-bold profile_exp_font myexperience color-black1 ellipsis" onclick="toggleEllipsis(this)"><?php echo e($ue->title); ?></p>
                            <p class="w-50 m-0 p-0 text-left profile_exp_font myexp_company color-black2 ellipsis" onclick="toggleEllipsis(this)"><?php echo e($ue->company); ?></p>
                            <p class="w-50 m-0 p-0 mt-2 myexp_location color-black2 ellipsis" onclick="toggleEllipsis(this)">
                                <!-- <img src="/assets/images/location.png">&nbsp;<?php echo e((isset($countries[$ue->country_code]) ? $countries[$ue->country_code] : '' ) .', '.$ue->city); ?></p> -->
                                <span class="fa fa-map-marker"></span>&nbsp;<?php echo e((isset($countries[$ue->country_code]) ? $countries[$ue->country_code] : '' ) .', '.$ue->city); ?></p>
                            <p class="w-50 m-0 p-0 text-left mt-2 myexp_location color-black2 ellipsis" onclick="toggleEllipsis(this)"><?php echo e(date("F, Y", strtotime($ue->from_date))); ?> - 
                            <?php if($ue->currently_working == 1): ?>
                                Present
                            <?php else: ?>	
                                <?php echo e(date("F, Y", strtotime($ue->to_date))); ?>
                        ...
                        <div class="row m-0 p-0 mb-2 profile_company show_mobile">
                            <p class="w-100 m-0 p-0 font-weight-bold profile_exp_font myexperience color-black1 ellipsis" onclick="toggleEllipsis(this)"><?php echo e($ue->title); ?></p>
                            <p class="w-100 m-0 p-0 text-left profile_exp_font myexp_company color-black2 ellipsis" onclick="toggleEllipsis(this)"><?php echo e($ue->company); ?></p>
                            <p class="w-100 m-0 p-0 mt-2 myexp_location color-black2 ellipsis" onclick="toggleEllipsis(this)">
                                <!-- <img src="/assets/images/location.png">&nbsp;<?php echo e((isset($countries[$ue->country_code]) ? $countries[$ue->country_code] : '' ) .', '.$ue->city); ?></p> -->
                                <span class="fa fa-map-marker"></span>&nbsp;<?php echo e((isset($countries[$ue->country_code]) ? $countries[$ue->country_code] : '' ) .', '.$ue->city); ?></p>
                            <p class="w-100 m-0 p-0 text-left mt-2 myexp_location color-black2 ellipsis" onclick="toggleEllipsis(this)"><?php echo e(date("F, Y", strtotime($ue->from_date))); ?> - 
                            <?php if($ue->currently_working == 1): ?>
                                Present
                            <?php else: ?>	
                                <?php echo e(date("F, Y", strtotime($ue->to_date))); ?>
                ...
                <div class="row m-0 p-0 ">
                    <div class="mt-3 w-100 profile_experience">
                        ...
                        <div class="row m-0 p-0 mb-2 profile_company hide_mobile">
                            <p class="w-50 m-0 p-0 font-weight-bold profile_exp_font myexperience color-black1 ellipsis" onclick="toggleEllipsis(this)"><?php echo e($ue->title); ?></p>
                            <p class="w-50 m-0 p-0 text-left profile_exp_font myexp_company color-black2 ellipsis" onclick="toggleEllipsis(this)"><?php echo e($ue->school); ?></p>
                            <!-- <p class="w-50 m-0 p-0"><img src="/assets/images/location.png">&nbsp;<?php echo e((isset($countries[$ue->country_code]) ? $countries[$ue->country_code] : '' ) .', '.$ue->city); ?></p> -->
                            <p class="w-50 m-0 p-0 mt-2 myexp_location color-black2 ellipsis" onclick="toggleEllipsis(this)"><span class="fa fa-map-marker"></span>&nbsp;<?php echo e((isset($countries[$ue->country_code]) ? $countries[$ue->country_code] : '' ) .', '.$ue->city); ?></p>
                            <p class="w-50 m-0 p-0 text-left mt-2 myexp_location color-black2 ellipsis" onclick="toggleEllipsis(this)"><?php echo e($ue->from_year); ?> to <?php echo e($ue && $ue->to_year !=null ?  $ue->to_year : 'Present'); ?>

                            </p>
                        </div>
                        <!-- mobile -->
                        <div class="row m-0 p-0 mb-2 profile_company show_mobile">
                            <p class="w-100 m-0 p-0 font-weight-bold profile_exp_font myexperience color-black1"><?php echo e($ue->title); ?></p>
                            <p class="w-100 m-0 p-0 text-left profile_exp_font myexp_company color-black2 ellipsis" onclick="toggleEllipsis(this)"><?php echo e($ue->school); ?></p>
                            <!-- <p class="w-50 m-0 p-0"><img src="/assets/images/location.png">&nbsp;<?php echo e((isset($countries[$ue->country_code]) ? $countries[$ue->country_code] : '' ) .', '.$ue->city); ?></p> -->
                            <p class="w-100 m-0 p-0 mt-2 myexp_location color-black2 ellipsis" onclick="toggleEllipsis(this)"><span class="fa fa-map-marker"></span>&nbsp;<?php echo e((isset($countries[$ue->country_code]) ? $countries[$ue->country_code] : '' ) .', '.$ue->city); ?></p>
                            <p class="w-100 m-0 p-0 text-left mt-2 myexp_location color-black2 ellipsis" onclick="toggleEllipsis(this)"><?php echo e($ue->from_year); ?> to <?php echo e($ue && $ue->to_year != null ?  $ue->to_year : 'Present'); ?>
                ...
                <div class="row m-0 p-0 ">
                    <div class="w-100 profile_pitch">
                        ...
                        <ul class="list-unstyled list-inline margin-0-auto mb-0 request_skills">
                            <?php $__currentLoopData = $opc_roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $oc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="w-100 profile_pitch">
                        ...
                        <li class="list-inline-item mr-0 pr-2 pt-2">
                            <div class="chip color-experience mr-0 custom_endorse">
                                <p style="margin: 0px;"><?php echo e($oc); ?></p>
                              
                                <span >
                                    <?php if(in_array($logged_in_user_id, $opc_endorse[$oc])): ?>
                                    <a href="#" data-type="checklist" data-source="<?php echo e(URL::to('/')); ?>/ajax/get_endorse_list/<?php echo e($opc->user_id); ?>/<?php echo e($oc); ?>"  data-title="Endorsed User list" class="endorse_list editable editable-click" data-placement="bottom"   data-original-title="" title="" data-logined="<?php echo e($logged_in_user_id); ?>"><img src='/assets/images/Icon-endorsed.svg' alt='Endorse' style='width:30px;' /></a>
                                        <?php if(count($opc_endorse[$oc])): ?>
                                        <span>X <?php echo e(count($opc_endorse[$oc])); ?></span>
                                        <?php endif; ?>
                                    <span class="opentowork_endorse float-right pl-4"  data-opt-skill="<?php echo e($oc); ?>" data-opt-id="<?php echo e($opc->id); ?>" data-user-id="<?php echo e($opc->user_id); ?>" class="undo_icon">Undo</span>
                                    
                                    <?php else: ?>

                                        <?php if(count($opc_endorse[$oc])): ?>
                                             <a href="#"  data-pk="<?php echo e($opc->user_id); ?>" data-type="checklist" data-source="<?php echo e(URL::to('/')); ?>/ajax/get_endorse_list/<?php echo e($opc->user_id); ?>/<?php echo e($oc); ?>"  data-title="Endorsed User list" class="endorse_list editable editable-click" data-placement="bottom"   data-original-title="" title="" data-logined="<?php echo e($logged_in_user_id); ?>"><img src='/assets/images/Icon-endorsed.svg' alt='Endorse' style='width:30px;' /></a>                                        
                                            <span>X <?php echo e(count($opc_endorse[$oc])); ?></span>
                                        <?php else: ?>
                                            <img src='/assets/images/Icon-endorsed-1.svg' alt='Endorse' style='width:30px;' />
                                        <?php endif; ?>
                                        <span class="opentowork_endorse float-right pl-4"  data-opt-skill="<?php echo e($oc); ?>" data-user-id="<?php echo e($opc->user_id); ?>" data-opt-id="<?php echo e($opc->id); ?>" class="undo_icon">Endorse</span>
                                    <?php endif; ?>
                                </span>
                            </div>
                        </li>
                ...
                <div class="row m-0 p-0 mt-5">
					<?php if($user_id): ?>	
						<div class="w-100 m-0 p-0">	
							...
							<a href="#" id="opportunity_share" data-type="text" data-title="Copy this link to share" class="editable editable-click  float-right  text-decoration-none textcolor-blue  pr-2 pl-2 opt_align_mobile" data-placement="bottom" data-original-title="" title="" data-value="<?php echo e(URL::to('/')); ?>/opentowork/<?php echo e($opc->id); ?>#">Share</a> 
							<a id="export_PDF" data-id="<?php echo e($opc->id); ?>" data-type="opw" class="editable editable-click  float-right  text-decoration-none textcolor-blue  pr-2 pl-2 cusor_pointer opt_align_mobile" >Download PDF</a> 
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\XAMPP7.4\htdocs\growyspace 2.0\resources\views/opentowork_card.blade.php ENDPATH**/ ?>